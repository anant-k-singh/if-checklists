...
export enum NavLights {
  ON = 'Nav Lights - ON',
  OFF = 'Nav Lights - OFF',
}

export enum BeaconLights {
  ON = 'Beacon Lights - ON',
  OFF = 'Beacon Lights - OFF',
}

export enum StrobeLights {
  ON = 'Strobe Lights - ON',
